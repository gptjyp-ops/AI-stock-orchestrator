...
def make_report(config: dict, prices: dict[str, pd.DataFrame], now: datetime) -> tuple[str, str, dict[str, str]]:
    ...
    nav = "<nav class='nav'><a href='index.html'>대시보드</a><a href='briefing.html'>오늘 브리핑</a><a href='stocks.html'>종목분석</a><a href='sectors.html'>업종분석</a><a href='disclosures.html'>긍정공시</a><a href='signals.html'>매매신호</a></nav>"
